      ...
      <div className="md:flex items-start justify-center py-12 2xl:px-20 md:px-6 px-4">
        <div className="xl:w-[600px] xl:h-[600px] lg:w-[50vw] lg:h-[50vw] md:block md:w-[50vw] md:h-[50vw] hidden">
          <motion.img
            ...
            className="xl:w-[600px] xl:h-[600px] lg:w-[50vw] lg:h-[50vw]"
            style={{
              objectFit: "cover",
              width: "600px",
              height: "550px",
        ...
        <div className="xl:w-2/5 md:w-1/2 lg:ml-8 md:ml-6 md:mt-0 mt-6">
          ...
          <p className="lg:leading-tight leading-normal text-gray-600 mt-7 text-xl">
            {discription}
          </p>
          <div>
            ...
            <div className={"flex justify-between items-center w-72"}>
              ...
              {!Loading && (
                <RiSendPlane2Fill
                  ...
                  className={
                    "text-gray-800 cursor-pointer hover:text-gray-950 border-1 border-black p-2 rounded-full"
                  }
                  style={{
                    fontSize: "38px",
                  }}
